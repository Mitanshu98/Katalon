 /*
Title:- Non - Expedited reporting requirements overview - PSUR Periodic reporting rules (Report ID 200)
Owner:- Mitanshu Gupta
Description:- In this test case we are creating a record in PSUR and complete the workflow and then checking the fields of PSUR in the Tabular reports.
...
WebUI.comment('This is a verify step for checking the PSUR Periodic reporting form shall be displayed.')
...
WebUI.comment('This is a verify step for checking the PSUR form shall be displayed')
