...
WebUI.waitForElementVisible(findTestObject('Test Cases/Whom and When/Report/Case Handler - Clinical Device'), GlobalVariable.Timeout)

WebUI.click(findTestObject('Test Cases/Whom and When/Report/Case Handler - Clinical Device'))
...
WebUI.scrollToElement(findTestObject('Test Cases/Whom and When/scroll/Created By - CH Clinical Device'), GlobalVariable.Timeout)
