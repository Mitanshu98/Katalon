 /*
 Title:- Whom and When (Case Handling - Clinical Drug)
 Owner:- Mitanshu Gupta
 Description:- In this test case we are creating a record in ICSR Reprting requiremnts with Case Handling - Clinical Drug.
...
WebUI.waitForElementVisible(findTestObject('Test Cases/Reports/Whom and When/Report/Case Handlers - Clinical Drug'), GlobalVariable.Timeout)

WebUI.click(findTestObject('Test Cases/Reports/Whom and When/Report/Case Handlers - Clinical Drug'))
...
WebUI.scrollToElement(findTestObject('Test Cases/Reports/Whom and When/scroll/Created by - CH - Clinical Drug'), GlobalVariable.Timeout)
