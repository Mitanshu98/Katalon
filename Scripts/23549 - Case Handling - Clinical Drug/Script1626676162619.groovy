...
WebUI.waitForElementVisible(findTestObject('Test Cases/Whom and When/Report/Case Handlers - Clinical Drug'), GlobalVariable.Timeout)

WebUI.click(findTestObject('Test Cases/Whom and When/Report/Case Handlers - Clinical Drug'))
...
WebUI.scrollToElement(findTestObject('Test Cases/Whom and When/scroll/Created by - CH - Clinical Drug'), GlobalVariable.Timeout)
