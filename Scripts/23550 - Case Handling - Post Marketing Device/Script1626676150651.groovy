 ...
 Description:- In this test case we are creating a record in ICSR Reprting requiremnts with Case Handling - Post marketing Devie.
...
WebUI.waitForElementVisible(findTestObject('Test Cases/Reports/Whom and When/Report/Case Handler - Post Marketing Device'), 
    GlobalVariable.Timeout)

WebUI.click(findTestObject('Test Cases/Reports/Whom and When/Report/Case Handler - Post Marketing Device'))
...
WebUI.scrollToElement(findTestObject('Test Cases/Reports/Whom and When/scroll/Created by - CH - Post'), GlobalVariable.Timeout)
