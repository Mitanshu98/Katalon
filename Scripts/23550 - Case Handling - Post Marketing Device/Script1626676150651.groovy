...
WebUI.waitForElementVisible(findTestObject('Test Cases/Whom and When/Report/Case Handler - Post Marketing Device'), 
    GlobalVariable.Timeout)

WebUI.click(findTestObject('Test Cases/Whom and When/Report/Case Handler - Post Marketing Device'))
...
WebUI.scrollToElement(findTestObject('Test Cases/Whom and When/scroll/Created by - CH - Post'), GlobalVariable.Timeout)
