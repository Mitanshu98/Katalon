...
WebUI.waitForElementVisible(findTestObject('Test Cases/Whom and When/Report/Case Handlers - Solicated Drug'), GlobalVariable.Timeout)

WebUI.click(findTestObject('Test Cases/Whom and When/Report/Case Handlers - Solicated Drug'))
...
WebUI.scrollToElement(findTestObject('Test Cases/Whom and When/scroll/Created by - CH -Solicated Drug'), GlobalVariable.Timeout)
