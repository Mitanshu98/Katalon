...
WebUI.waitForElementVisible(findTestObject('Test Cases/Whom and When/Report/Case Handlers - Spontaneous drug'), 
    GlobalVariable.Timeout)

WebUI.click(findTestObject('Test Cases/Whom and When/Report/Case Handlers - Spontaneous drug'))
...
WebUI.scrollToElement(findTestObject('Test Cases/Whom and When/scroll/Created by - ch-spontaneous'), GlobalVariable.Timeout)
