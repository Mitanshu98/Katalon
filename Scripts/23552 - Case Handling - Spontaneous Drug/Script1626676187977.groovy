 /*
 Title:- Whom and When (Case Handling - Spontaneous Drug)
 Owner:- Mitanshu Gupta
 Description:- In this test case we are creating a record in ICSR Reprting requiremnts with Case Handling - Spontaneous Drug.
...
WebUI.waitForElementVisible(findTestObject('Test Cases/Reports/Whom and When/Report/Case Handlers - Spontaneous drug'), 
    GlobalVariable.Timeout)

WebUI.click(findTestObject('Test Cases/Reports/Whom and When/Report/Case Handlers - Spontaneous drug'))
...
WebUI.scrollToElement(findTestObject('Test Cases/Reports/Whom and When/scroll/Created by - ch-spontaneous'), GlobalVariable.Timeout)
