...
WebUI.waitForElementVisible(findTestObject('Test Cases/Whom and When/Report/Submission - Clinical device'), GlobalVariable.Timeout)

WebUI.click(findTestObject('Test Cases/Whom and When/Report/Submission - Clinical device'))
...
WebUI.scrollToElement(findTestObject('Test Cases/Whom and When/scroll/Sub_cli_dev_1'), GlobalVariable.Timeout)

WebUI.takeFullPageScreenshot()

WebUI.scrollToElement(findTestObject('Test Cases/Whom and When/scroll/Sub_cli_dev_2'), GlobalVariable.Timeout)
