 /*
 Title:- Whom and When (Submission - Clinical Drug)
 Owner:- Mitanshu Gupta
 Description:- In this test case we are creating a record in ICSR Reprting requiremnts with Submission - Clinical Drug.
...
WebUI.waitForElementVisible(findTestObject('Test Cases/Whom and When/Report/Submission - Clinical drug'), GlobalVariable.Timeout)

WebUI.click(findTestObject('Test Cases/Whom and When/Report/Submission - Clinical drug'))
...
WebUI.scrollToElement(findTestObject('Test Cases/Whom and When/scroll/Sub_cli_drug_1'), GlobalVariable.Timeout)

WebUI.takeFullPageScreenshot()

WebUI.scrollToElement(findTestObject('Test Cases/Whom and When/scroll/Sub_cli_drug_2'), GlobalVariable.Timeout)
