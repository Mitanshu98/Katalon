...
WebUI.waitForElementVisible(findTestObject('Test Cases/Whom and When/Report/Submission - Post marketing device'), 
    GlobalVariable.Timeout)

WebUI.click(findTestObject('Test Cases/Whom and When/Report/Submission - Post marketing device'))
...
WebUI.scrollToElement(findTestObject('Test Cases/Whom and When/scroll/Sub_post_1'), GlobalVariable.Timeout)

WebUI.takeFullPageScreenshot()

WebUI.scrollToElement(findTestObject('Test Cases/Whom and When/scroll/Sub_post_2'), GlobalVariable.Timeout)
