 /*
 Title:- Whom and When (Submission - Solicated Drug)
 Owner:- Mitanshu Gupta
 Description:- In this test case we are creating a record in ICSR Reprting requiremnts with Submission - Solicated Drug.
...
WebUI.check(findTestObject('Test Cases/Whom and When/Reporting Criteria/Fatel'), FailureHandling.STOP_ON_FAILURE)

WebUI.check(findTestObject('Test Cases/Whom and When/Reporting Criteria/Life Threatening'), FailureHandling.STOP_ON_FAILURE)

WebUI.check(findTestObject('Test Cases/Whom and When/Reporting Criteria/Other Seriousness'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.waitForElementVisible(findTestObject('Test Cases/Whom and When/Submission'), GlobalVariable.Timeout, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.check(findTestObject('Test Cases/Whom and When/Submission'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.waitForElementVisible(findTestObject('Test Cases/Whom and When/Report/Submission - Solicited Drug'), GlobalVariable.Timeout)

WebUI.click(findTestObject('Test Cases/Whom and When/Report/Submission - Solicited Drug'))
...
WebUI.scrollToElement(findTestObject('Test Cases/Whom and When/scroll/Sub_Solicited_1'), GlobalVariable.Timeout)

WebUI.takeFullPageScreenshot()

WebUI.scrollToElement(findTestObject('Test Cases/Whom and When/scroll/Sub_Solicited_2'), GlobalVariable.Timeout)
