...
WebUI.waitForElementVisible(findTestObject('Test Cases/Reports/Whom and When/Report/Submission - Solicited Drug'), GlobalVariable.Timeout)

WebUI.click(findTestObject('Test Cases/Reports/Whom and When/Report/Submission - Solicited Drug'))
...
WebUI.scrollToElement(findTestObject('Test Cases/Reports/Whom and When/scroll/Sub_Solicited_1'), GlobalVariable.Timeout)

WebUI.takeFullPageScreenshot()

WebUI.scrollToElement(findTestObject('Test Cases/Reports/Whom and When/scroll/Sub_Solicited_2'), GlobalVariable.Timeout)
