 /*
 Title:- Whom and When (Submission - Spontaneous Drug)
 Owner:- Mitanshu Gupta
 Description:- In this test case we are creating a record in ICSR Reprting requiremnts with Submission - Spontaneous Drug.
...
WebUI.waitForElementVisible(findTestObject('Test Cases/Whom and When/Report/Submission - Spontaneous - Drug'), GlobalVariable.Timeout)

WebUI.click(findTestObject('Test Cases/Whom and When/Report/Submission - Spontaneous - Drug'))
...
WebUI.scrollToElement(findTestObject('Test Cases/Whom and When/scroll/Sub_Spont_1'), GlobalVariable.Timeout)

WebUI.takeFullPageScreenshot()

WebUI.scrollToElement(findTestObject('Test Cases/Whom and When/scroll/Sub_Spont_2'), GlobalVariable.Timeout)
