 /*
 Title:- Assign user group to user with Read only Attribute.
 Owner:- Mitanshu Gupta
 Description:- In this Test case the user is creating a new test user and setup roles for the user with Read only Access.
...
WebUI.comment('This is a verify step for checking the user can not create record with Read only Access.')
