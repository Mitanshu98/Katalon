 /*
 Title:- Whom and When (Case Handling - Clinical Device)
 Owner:- Mitanshu Gupta
 Description:- In this test case we are creating a record in ICSR Reprting requiremnts with Case Handling - Clinical device.
...
WebUI.waitForElementVisible(findTestObject('Test Cases/Reports/Whom and When/Report/Case Handler - Clinical Device'), GlobalVariable.Timeout)

WebUI.click(findTestObject('Test Cases/Reports/Whom and When/Report/Case Handler - Clinical Device'))
...
WebUI.scrollToElement(findTestObject('Test Cases/Reports/Whom and When/scroll/Created By - CH Clinical Device'), GlobalVariable.Timeout)
