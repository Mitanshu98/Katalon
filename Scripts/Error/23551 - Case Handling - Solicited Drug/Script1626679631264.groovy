 /*
 Title:- Whom and When (Case Handling - Solicated Drug)
 Owner:- Mitanshu Gupta
 Description:- In this test case we are creating a record in ICSR Reprting requiremnts with Case Handling - Solicated Drug.
...
WebUI.waitForElementVisible(findTestObject('Test Cases/Reports/Whom and When/Report/Case Handlers - Solicated Drug'), GlobalVariable.Timeout)

WebUI.click(findTestObject('Test Cases/Reports/Whom and When/Report/Case Handlers - Solicated Drug'))
...
WebUI.scrollToElement(findTestObject('Test Cases/Reports/Whom and When/scroll/Created by - CH -Solicated Drug'), GlobalVariable.Timeout)
