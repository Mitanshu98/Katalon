...
WebUI.waitForElementVisible(findTestObject('Test Cases/Reports/Whom and When/Report/Submission - Clinical drug'), GlobalVariable.Timeout)

WebUI.click(findTestObject('Test Cases/Reports/Whom and When/Report/Submission - Clinical drug'))
...
WebUI.scrollToElement(findTestObject('Test Cases/Reports/Whom and When/scroll/Sub_cli_drug_1'), GlobalVariable.Timeout)

WebUI.takeFullPageScreenshot()

WebUI.scrollToElement(findTestObject('Test Cases/Reports/Whom and When/scroll/Sub_cli_drug_2'), GlobalVariable.Timeout)
