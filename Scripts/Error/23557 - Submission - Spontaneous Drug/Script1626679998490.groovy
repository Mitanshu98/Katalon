...
WebUI.check(findTestObject('Test Cases/Reports/Whom and When/Reporting Criteria/Fatel'), FailureHandling.STOP_ON_FAILURE)

WebUI.check(findTestObject('Test Cases/Reports/Whom and When/Reporting Criteria/Life Threatening'), FailureHandling.STOP_ON_FAILURE)

WebUI.check(findTestObject('Test Cases/Reports/Whom and When/Reporting Criteria/Other Seriousness'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.waitForElementVisible(findTestObject('Test Cases/Reports/Whom and When/Report/Submission - Spontaneous - Drug'), GlobalVariable.Timeout)

WebUI.click(findTestObject('Test Cases/Reports/Whom and When/Report/Submission - Spontaneous - Drug'))
...
WebUI.scrollToElement(findTestObject('Test Cases/Reports/Whom and When/scroll/Sub_Spont_1'), GlobalVariable.Timeout)

WebUI.takeFullPageScreenshot()

WebUI.scrollToElement(findTestObject('Test Cases/Reports/Whom and When/scroll/Sub_Spont_2'), GlobalVariable.Timeout)
