...
//WebUI.setText(findTestObject('HALO Front-End/User administration/Searchfield'), User)

//WebUI.click(findTestObject('HALO Front-End/User administration/Search button'))

//WebUI.waitForElementVisible(findTestObject('HALO Front-End/User administration/Pencil'), GlobalVariable.Timeout)

WebUI.click(findTestObject('HALO Front-End/User administration/Pencil'))
